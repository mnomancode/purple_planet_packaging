...
import 'package:purple_planet_packaging/app/core/mixin/loading_overlay_mixin.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                if (!authController.isRegistering) ...[
                  10.verticalSpace,
                  Row(
                ...
                Row(
                  ...
                  children: [
                    Text(!authController.isRegistering ? 'Don\'t have an account?' : 'Already have an account?',
                        style: AppStyles.mediumStyle()),
                    TextButton(
                      onPressed: () {
                        ref.read(authProvider.notifier).register();
                      },
                      child: Text(!authController.isRegistering ? 'Register' : 'Sign In',
