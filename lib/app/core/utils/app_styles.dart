...
class AppStyles {
  ...
  static TextStyle hintStyle({Color? color, double fontSize = 14.0}) {
    return GoogleFonts.montserrat(color: color ?? Colors.grey, fontSize: fontSize);
  }

  static TextStyle lightStyle({Color? color, double fontSize = 14.0}) {
    return GoogleFonts.montserrat(color: color, fontSize: fontSize);
  }
  ...
  static TextStyle mediumBoldStyle({Color? color, double fontSize = 16.0}) {
    return GoogleFonts.montserrat(color: color, fontSize: fontSize, fontWeight: FontWeight.bold);
  }

  static TextStyle boldStyle({Color? color, double fontSize = 16.0, FontWeight? fontWeight}) {
    return GoogleFonts.montserrat(color: color, fontSize: fontSize, fontWeight: fontWeight ?? FontWeight.w600);
  }
